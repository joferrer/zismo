...
import 'package:zimoapp1/widgets.dart';
import 'package:zimoapp1/sensor_page.dart';
        ...
        child: Column(
          children: <Widget>[
            ...
            StreamBuilder<List<BluetoothService>>(
              ...
              initialData: [],
              builder: (c, snapshot) {
                List<BluetoothService>? l = snapshot.data ?? List.empty();
                return Column(
                  children: _buildServiceTiles(l) ?? List.empty(),
                );
              },
            ),
          ],
